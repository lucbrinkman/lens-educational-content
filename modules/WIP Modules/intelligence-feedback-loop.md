...
The economics case feels so easy to point at that it's hard to find basic sources about it. Bastani on marginal cost converging to zero is probably too specific and also not public domain. I'd want to use marx, but possibly aestheti
