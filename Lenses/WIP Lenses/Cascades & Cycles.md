...
An article that explains positive feedback loops especially with regards to civilisational competence. It explains "cascades" as breakthroughs which probabilisticly  opens up other breakthroughs in related fields and "cycles" as processes which generate some excess quantity that can be reinvested into the same process. examples provided are neutron multiplication in radioactive materials as a cycle  
