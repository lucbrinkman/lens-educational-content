...
source:: [[../articles/attachments/cascades-cycles-insig]] {>>Luc: use Obsiidan serach and search for this URL. You'll find the filename.md that contains this article. Then you can link that article specifically.<<}
